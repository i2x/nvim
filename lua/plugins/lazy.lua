...
require('lazy').setup({
  ...
  -- Color scheme
  {
    ...
    config = function()
      require('catppuccin').setup({
        ...
        -- Customize other options here if necessary
      })
      -- Set the colorscheme to 'catppuccin-macchiato'
  ...
  -- Autocompletion
  {
    ...
    config = function()
      ...
      cmp.setup({
        preselect = cmp.PreselectMode.Item, -- Automatically preselect the first suggestion
